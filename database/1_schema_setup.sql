-- 1_schema_setup.sql
-- Solar Panel Site Analyzer - Database Schema (MySQL 8.0+)
...
BEGIN
    ...
    read_loop: LOOP
        ...
        INSERT INTO analysis_results (
            site_id, solar_irradiance_score, area_score, grid_distance_score, slope_score, 
            infrastructure_score, total_suitability_score, parameters_snapshot
        ) VALUES (
            v_site_id, v_solar_score, v_area_score, v_grid_score, v_slope_score, v_infra_score, v_total_score,
            JSON_OBJECT(
